  ...
  return (
      <div className='py-16 md:py-0 bg-shop_normal_green rounded-lg px-10 lg:px-24 flex items-center justify-between'>
          <div className='space-y-5'>
              ...
              <Link href={"/shop"} className='bg-shop_dark_green/90 text-shop_light_yellow px-5 py-2 rounded-md text-sm font-semibold hover:text-shop_dark_green hover:bg-shop_light_yellow hoverEffect'>Buy Now</Link>
          </div>        
          <div>
